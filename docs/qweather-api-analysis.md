...
> 本文是 2026-04-25 的历史盘点，文中的“当前项目状态”和“待接入”均冻结在当时，不能用于判断现在的代码。
> 当前完整目录与项目映射见 [和风天气 API 完整整理（2026-07）](./qweather-api-reference-2026-07.md)，
> 本轮已实施变化见 [和风天气 API 更新核对（2026-07-25）](./qweather-api-update-2026-07.md)。
